...
public class Roupa extends Produto {
    ...
    //*Construtores*//
    public Roupa(Produto p, String tipo, String tamanho, String marca, String sexo){
    ...
    public Object clone(){
        Roupa novo = new Roupa(new Produto(super.getNome(), super.getDesconto(), super.getPreco(), super.getEstoque()), this.tipo, this.tamanho, this.marca, this.sexo);
        return novo;
    }

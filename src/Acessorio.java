...
public class Acessorio extends Produto implements Serializable {
    //*Declarações*//
    private String tipo;
    ...
    //*Construtores*//
    public Acessorio(Produto p, String tipo, String tamanho, String marca, String sexo){
    ...
    public Object clone(){
        Acessorio novo = new Acessorio(new Produto(super.getNome(), super.getDesconto(), super.getPreco(), super.getEstoque()), this.tipo, this.tamanho, this.marca, this.sexo);
        return novo;
    }
